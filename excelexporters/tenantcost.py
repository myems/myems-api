...
def generate_excel(report,
    ...
    if has_subtotals_data_flag:
        ...
        ws['B' + str(current_row_flag)] = name + ' 成本占比'
        ...
        ws['C' + str(current_row_flag)] = '成本占比'
        ...
        for i in range(0, ca_len):
            ...
            ws['C' + str(current_row_flag)].alignment = c_c_alignment
            ws['C' + str(current_row_flag)].border = f_border
            ws['C' + str(current_row_flag)] = round(reporting_period_data['subtotals'][i], 2)
    ...
    if has_detail_data_flag:
        ...
        if has_data:
            ...
            ws[end_col + str(current_row_flag)].fill = table_fill
            ws[end_col + str(current_row_flag)].font = title_font
            ws[end_col + str(current_row_flag)].alignment = c_c_alignment
            ws[end_col + str(current_row_flag)] = "总计 (" + reporting_period_data['total_unit'] + ")"
            ws[end_col + str(current_row_flag)].border = f_border
            ...
            for i in range(0, len(time)):
                ...
                for j in range(0, ca_len):
                    ...
                    ws[col + str(current_row_flag)] = value
                    ws[col + str(current_row_flag)].border = f_border

                end_col = chr(ord(col) + 1)
                ws[end_col + str(current_row_flag)].font = title_font
                ws[end_col + str(current_row_flag)].alignment = c_c_alignment
                ws[end_col + str(current_row_flag)] = round(every_day_total, 0)
                ws[end_col + str(current_row_flag)].border = f_border
            ...
            ws[end_col + str(current_row_flag)].font = title_font
            ws[end_col + str(current_row_flag)].alignment = c_c_alignment
            ws[end_col + str(current_row_flag)] = round(reporting_period_data['total'], 0)
            ws[end_col + str(current_row_flag)].border = f_border
